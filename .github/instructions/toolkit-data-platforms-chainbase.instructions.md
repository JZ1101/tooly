...
To expose these tools over SSE:
...
- Chainbase enforces per-key rate limits; handle `{"error": "...429..."}` responses by backing off or narrowing ranges.
...
- [Desearch Platform](./toolkit-data-platforms-desearch.instructions.md) - Search and discovery tools
